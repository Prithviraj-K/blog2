...
function _createMdxContent(props) {
  ...
  if (!Text) _missingMdxReference("Text", true, "1:1-4:3");
  ...
  }), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.p, null, "I'm Raj Khandekar."), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.p, null, "Join me as I document my journey through the OSCP certification and beyond."), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.p, null, "Currently, I am working through the course content while completing the ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.a, {
    href: "https://docs.google.com/spreadsheets/u/1/d/1dwSMIAPIam0PuRBkCiDI88pU3yzrqqHkDtBngUHNCw8/htmlview#"
  }, "TJ Null List"), " for proving grounds. The specific boxes are completed in my blog posts below."));
}
function MDXContent(props = {}) {
  const {
    wrapper: MDXLayout
...
function _missingMdxReference(id, component, place) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it." + (place ? "\nIt’s referenced in your code at `" + place + "` in `/Users/rajkhandekar/Documents/blog/blog2/src/@lekoarts/gatsby-theme-minimal-blog/texts/hero.mdx`" : ""));
}
