...
var darken = function darken(c, n) {
  return function (t) {
    return P__namespace.darken(n, getColor(t, c));
  };
};
/**
...
var lighten = function lighten(c, n) {
  return function (t) {
    return P__namespace.lighten(n, getColor(t, c));
  };
};
/**
...
var rotate = function rotate(c, d) {
  return function (t) {
    return P__namespace.adjustHue(d, getColor(t, c));
  };
};
/**
...
var hue = function hue(c, h) {
  return function (t) {
    return P__namespace.setHue(h, getColor(t, c));
  };
};
/**
...
var saturation = function saturation(c, s) {
  return function (t) {
    return P__namespace.setSaturation(s, getColor(t, c));
  };
};
/**
...
var lightness = function lightness(c, l) {
  return function (t) {
    return P__namespace.setLightness(l, getColor(t, c));
  };
};
/**
...
var desaturate = function desaturate(c, n) {
  return function (t) {
    return P__namespace.desaturate(n, getColor(t, c));
  };
};
/**
...
var saturate = function saturate(c, n) {
  return function (t) {
    return P__namespace.saturate(n, getColor(t, c));
  };
};
/**
...
var shade = function shade(c, n) {
  return function (t) {
    return P__namespace.shade(n, getColor(t, c));
  };
};
/**
...
var tint = function tint(c, n) {
  return function (t) {
    return P__namespace.tint(n, getColor(t, c));
  };
};
var transparentize = function transparentize(c, n) {
  return function (t) {
    return P__namespace.transparentize(n, getColor(t, c));
  };
};
/**
...
var alpha = function alpha(c, n) {
  return function (t) {
    return P__namespace.rgba(getColor(t, c), n);
  };
};
/**
...
var mix = function mix(a, b, n) {
  ...
  return function (t) {
    return P__namespace.mix(n, getColor(t, a), getColor(t, b));
  };
};
/**
...
var complement = function complement(c) {
  return function (t) {
    return P__namespace.complement(getColor(t, c));
  };
};
/**
...
var invert = function invert(c) {
  return function (t) {
    return P__namespace.invert(getColor(t, c));
  };
};
/**
